...
function initializeDOMElements() {
  videoElement = document.getElementById('v_src');
  canvasElement = document.getElementById('out');
  ctx = canvasElement.getContext('2d');
  narutoFx = document.getElementById('naruto-fx');
  sasukeFx = document.getElementById('sasuke-fx');
}
